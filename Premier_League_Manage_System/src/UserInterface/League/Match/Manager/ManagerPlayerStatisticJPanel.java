 ...
 * @author Jiafeng
 */
public class ManagerPlayerStatisticJPanel extends javax.swing.JPanel {
    ...
    public ManagerPlayerStatisticJPanel(Person managerTemp) {
        initComponents();
        ArrayList<String> PlayerCata;

        PlayerCata = new ArrayList<String>();
...
//        fillingAppointmentHistoryTable();
        ...
        try{
                ...
                String sql ="SELECT DISTINCT player FROM fan_rate WHERE "
                            + "(player IS NOT NULL) "
                            + "AND (player !=\'\');";
                ...
                while(resultSet.next()){
                    playerTemp = resultSet.getString("player");
                    PlayerCata.add(playerTemp);
    //                System.out.println(clubTemp);
        ...
        for(int i =0; i<(PlayerCata.size());i++)
        {
           PlayerNameStatisticComboBox.addItem(PlayerCata.get(i));
        }
    ...
    private void initComponents() {
        ...
        PlayerNameStatisticComboBox = new javax.swing.JComboBox<>();
        GradeStatisticComboBox = new javax.swing.JComboBox<>();
        ...
        jLabel14.setText("Player Statistic");

        PlayerNameStatisticComboBox.setSelectedIndex(-1);
        PlayerNameStatisticComboBox.setMinimumSize(new java.awt.Dimension(76, 25));
        PlayerNameStatisticComboBox.setPreferredSize(new java.awt.Dimension(76, 25));

        GradeStatisticComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "pass", "shot", "defend" }));
        GradeStatisticComboBox.setSelectedIndex(-1);
        GradeStatisticComboBox.setMinimumSize(new java.awt.Dimension(76, 25));
        GradeStatisticComboBox.setPreferredSize(new java.awt.Dimension(76, 25));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(PlayerNameStatisticComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(15, 15, 15)
                                        .addComponent(jLabel7)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(GradeStatisticComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(25, 25, 25)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(PlayerNameStatisticComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(GradeStatisticComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//       
        try{
                ...
                String sql = "SELECT "+ 
                             ...
                             "date"+
                             " FROM fan_rate WHERE "+
                             "player=\'"+playerNameTemp+"\'"; //2 represent doctor
                ...
                while(resultSet.next()){
                    gradeTemp = resultSet.getInt(gradeTypeTemp);
                    dateTemp = resultSet.getString("date");
                    barDataChart.setValue(gradeTemp,playerNameTemp,dateTemp);
...
//       
       JFreeChart jchart1 = ChartFactory.createBarChart(playerNameTemp, "Date of Matches", gradeTypeTemp, barDataChart, PlotOrientation.VERTICAL, true, true, false);
       JFreeChart jchart2 = ChartFactory.createPieChart3D(gradeTypeTemp, pieDataChart, true, true, false);
...
//        } 
    ...
    private javax.swing.JComboBox<String> GradeStatisticComboBox;
    private javax.swing.JComboBox<String> PlayerNameStatisticComboBox;
