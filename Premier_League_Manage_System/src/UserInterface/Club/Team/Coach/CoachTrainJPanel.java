 ...
 * @author Andrew Chou
 */
public class CoachTrainJPanel extends javax.swing.JPanel {
    Person person;
    ...
    /**
     * Creates new form CoachTrainJPanel
     */
    public CoachTrainJPanel() {
        initComponents();
    }
    
    public CoachTrainJPanel(Person person_Pass){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel43.setText("Current Selected Date:");

        SelectedDateLabel.setText("----------");

        jLabel44.setText("Traning Plan:");

        EditTrainingButton.setText("Edit");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(SelectedDateLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel44, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(EditTrainingButton))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                            ...
                            .addComponent(TrainingTextField))))
    ...
    private void decreaseYearButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decreaseYearButtonActionPerformed
        ...
        this.SelectedDateLabel.setText("----------");
    ...
    private void EditTrainingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditTrainingButtonActionPerformed
        // TODO add your handling code here:
        old_Value = this.TrainingTextField.getText();
        for (JLabel jLabel : calendarList) {
            jLabel.setEnabled(false);
        }
        this.TrainingTextField.setEnabled(true);
        this.EditTrainingButton.setEnabled(false);
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        if (old_Value.length() == 0 && new_Value.length() == 0) {
            JOptionPane.showMessageDialog(SaveButton, "Please fill in the training plan!", "Warning", JOptionPane.WARNING_MESSAGE);
        } else if (old_Value.equals(new_Value)) {// sth->sth
            JOptionPane.showMessageDialog(SaveButton, "Nothing Changed!", "Warning", JOptionPane.WARNING_MESSAGE);
        } else if (old_Value.length() != 0 && new_Value.length() == 0) {//delete
            int n = JOptionPane.showConfirmDialog(SaveButton, "Are you sure want to delete?", "Confirmation", JOptionPane.YES_NO_OPTION);
            if (n == 0) {//delete
                try {
        ...
        } else if (old_Value.length() == 0 && !old_Value.equals(new_Value)) {//insert
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                String url = "jdbc:mysql://localhost:3306/premierleague?zeroDateTimeBehavior=CONVERT_TO_NULL";
                String username = "root";
        ...
        } else if (old_Value.length() != 0 && !old_Value.equals(new_Value)) {
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                String url = "jdbc:mysql://localhost:3306/premierleague?zeroDateTimeBehavior=CONVERT_TO_NULL";
                String username = "root";
                ...
                int resultSet = statement.executeUpdate(sql);
                if (resultSet == 1) {
                    JOptionPane.showMessageDialog(SaveButton, "Update Successful!", "Congratulations!", JOptionPane.PLAIN_MESSAGE);
                }
                statement.close();
                connection.close();
            } catch (ClassNotFoundException | SQLException e) {
            ...
            jLabel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (jLabel.getText().length() != 0) {
                        int day = Integer.parseInt(jLabel.getText());
                        CoachTrainJPanel.day = day;
                        String train = "";
                        train = jLabel.getToolTipText();
                        settext(train);
                    }
                }
            });
    ...
    public void settext(String train) {
        String selected_month = "";
        String selected_day = "";
        if (day < 10) {
            selected_day = "0" + String.valueOf(day);
        } else {
            selected_day = String.valueOf(day);
        }
        if (month < 10) {
            selected_month = "0" + String.valueOf(month);
        } else {
            selected_month = String.valueOf(month);
        }
        this.SelectedDateLabel.setText(String.valueOf(year) + "-" + selected_month + "-" + selected_day);
        if (train == null) {
            this.TrainingTextField.setText("");
        } else {
            this.TrainingTextField.setText(train);
        }
